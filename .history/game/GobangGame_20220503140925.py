...
LastEditTime: 2022-05-03 14:07:04
'''
"""
...
class GobangGame:
    ...
    def update_ai_move(self)->None:
        ...
        if self.curIndex%2==1:
            next_step=self.searching_class_odd.Direction(self.chessManual,self.curIndex);
        else:
            next_step=self.searching_class_even.Direction(self.chessManual,self.curIndex);
